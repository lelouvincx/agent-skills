...
When the document you're writing is a skill, read `reference/skill-mechanics.md` for frontmatter, invocation choice, and router skills.
...
- **By invocation**, skill-specific: see `reference/skill-mechanics.md`.
