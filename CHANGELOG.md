...
- Make `Logseq: Log Current Task` queue a parent-thread turn that gives native Task a structured handoff and active workspace root instead of relying on `read_thread` reconstruction in a hidden worker.
