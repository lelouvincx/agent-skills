...
- Add `writing-investigation-docs` for evidence-first investigation, incident, PR decision, and RFC-style notes. [#65](https://github.com/lelouvincx/agent-skills/pull/65)
