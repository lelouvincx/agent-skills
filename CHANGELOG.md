...
- Add `managing-proto-image-deployments` for verified secret handoffs, bounded preview acceptance, explicit merge approval, and evidence-based deployment reviews. [#171](https://github.com/lelouvincx/agent-skills/pull/171)
