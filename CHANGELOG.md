...
- Make Logseq command workers create and repair Backlog tasks using the RFC-0008 Markdown task contract. [#118](https://github.com/lelouvincx/agent-skills/pull/118)
