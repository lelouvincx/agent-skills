...
- Add a `Herdr: Restart Background Runners` Amp command that creates a confirmation-gated worker thread for restarting background Amp runners from the always-on `agent-skills` runner.
