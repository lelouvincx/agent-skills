...
- Merge the controlled-English procedure and documentation guidance from `technical-precision` into `explaining-technical-concepts`, and remove the standalone skill.
