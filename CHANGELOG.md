...
- Allow Ultra mode in `spawn_subagent` while keeping Ultra review routing independent from the child-thread mechanism and retaining default Oracle for focused expert judgment.
