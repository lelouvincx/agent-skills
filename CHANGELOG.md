...
- Remove the `glm-5.2` experimental agent mode plugin and capability doc, since GLM 5.2 is now the default model for the built-in `low` mode per [The Dial](https://ampcode.com/news/the-dial).
