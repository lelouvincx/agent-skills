...
- Document Logseq report service-account authentication, biometric-free verification, and the fail-closed bot repository allowlist in the global Amp prompt. [#160](https://github.com/lelouvincx/agent-skills/pull/160)
