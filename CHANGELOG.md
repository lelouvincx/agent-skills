...
- Allow `agent-secrets` to resolve current one-time passwords through narrowly permitted 1Password OTP references, and register Demo4 credentials in the `work` bundle.
