...
- Add draft RFC-0011 for quiet isolated browser sessions, controlled human sign-in, and approved browser credentials through `agent-secrets`. [#212](https://github.com/lelouvincx/agent-skills/pull/212)
