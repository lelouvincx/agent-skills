...
- Limit Logseq coordinator Linear validation to `DAT`, `PS` and `DOC` issue IDs so identifiers such as `RFC-0012` do not prevent parent thread updates or worker archiving.
