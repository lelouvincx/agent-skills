...
- Add a current-state discovery of `dotfiles` and `agent-skills`, an environment-setup product definition and glossary, and a living design-grill decision record. [#207](https://github.com/lelouvincx/agent-skills/pull/207)
