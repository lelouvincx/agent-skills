...
- Update the `deepseek-v4-pro` agent mode to use the deprecated built-in Deep mode prompt and tool list (matching `deep-classic`), replacing the previous GLM 5.2-era prompt and narrower tool set.
