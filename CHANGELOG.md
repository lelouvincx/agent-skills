...
- Migrate active Amp capability documentation and validation to the role-preserving `amp-artifact/v2` contract, including separate Logseq tool and command artifacts. [#81](https://github.com/lelouvincx/agent-skills/pull/81)
