...
- Let `spawn_subagent` run locally, in an Amp Orb, or on a live runner selected by stable ID while preventing local `cwd` paths from reaching remote executors. [#110](https://github.com/lelouvincx/agent-skills/pull/110)
