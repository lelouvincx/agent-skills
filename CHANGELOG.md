...
- Add accepted RFC-0010, its staged implementation plan, and the validated local resolver and projection contract for shared local agent and bot secrets using capability bundles backed by one dedicated 1Password automation boundary.
