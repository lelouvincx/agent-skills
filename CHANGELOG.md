...
- Scope personal Amp instructions to explicit triggers and checkable behaviour, and remove Presales-specific guidance from the global projection. [#153](https://github.com/lelouvincx/agent-skills/pull/153)
