...
- Add `collaborating-with-claude-design` for structured design briefs, browser render gates, evidence-based iteration, and machine-readable handoffs. [#174](https://github.com/lelouvincx/agent-skills/pull/174)
