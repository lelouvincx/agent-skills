...
- Run Logseq logging workers in fixed `high` mode without recent-message seeds, require `read_thread` for parent context, and block Oracle escalation. [#94](https://github.com/lelouvincx/agent-skills/pull/94)
