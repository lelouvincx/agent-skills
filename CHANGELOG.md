...
- Document Logseq report service-account authentication, biometric-free verification, the fail-closed bot repository allowlist, and the bot-only publishing contract for this repository. [#160](https://github.com/lelouvincx/agent-skills/pull/160)
