...
- Label parent Amp threads from their Logseq backlog project, priority, and task state before archiving logging workers. [#111](https://github.com/lelouvincx/agent-skills/pull/111)
