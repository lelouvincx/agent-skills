...
source:
  kind: "plugin"
  file: "plugins/claude-opus-4-7.ts"
  scope: "system"
...
contract:
  ...
  event: null
  command_id: null
  agent_mode_key: "claude-opus-4-7"
...
- Mode key: `claude-opus-4-7`
- Label: `Claude Opus 4.7`
- Plugin file: `plugins/claude-opus-4-7.ts`
...
Select `Claude Opus 4.7` when starting a thread, then enter a normal coding request.
